...
66. Preventing the default Collapse -- Line 131
****************************************************/
...
// let aTagPrevent = document.querySelectorAll("team__name-wrap-7");
// aTagPrevent.forEach((a) => {
//   a.addEventListener("click", (ev) => {
//     ev.preventDefault();
//     let element = a.lastElementChild;

//     element.classList.toggle("remove-des")
...
/////////////////////////////////////////////////////
  ...
  if (scroll_top) {
    ...
    scroll_top.addEventListener('click', function (event) {
  ...
  if (device_width > 100) {
    ...
    splitTitleLines.forEach(splitTextLine => {
      ...
      gsap.set(splitTextLine, { perspective: 50 });
  ...
  let test = document.querySelectorAll(".team__name-wrap-7")
  test.forEach((div)=>{
    div.addEventListener("click", (event)=>{
      event.preventDefault();
      let targeted = div.parentElement.parentElement
      let elem = targeted.lastElementChild
      elem.classList.toggle("remove-des")
    })
  })
